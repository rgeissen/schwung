...
static const char CHAIN_PARAMS_JSON[] =
    ...
    "_keys\":[\"prog\"]}},{\"key\":\"root\",\"name\":\"Root\",\"short_name\":\"Root\",\"optio"
    "ns_as_string\":true,\"type\":\"enum\",\"options\":[\"C1\",\"C#1\",\"D1\",\"D#1\",\"E1\","
    "\"F1\",\"F#1\",\"G1\",\"G#1\",\"A1\",\"A#1\",\"B1\",\"C2\",\"C#2\",\"D2\",\"D#2\",\"E2\""
    ",\"F2\",\"F#2\",\"G2\",\"G#2\",\"A2\",\"A#2\",\"B2\",\"C3\",\"C#3\",\"D3\",\"D#3\",\"E3"
    "\",\"F3\",\"F#3\",\"G3\",\"G#3\",\"A3\",\"A#3\",\"B3\",\"C4\",\"C#4\",\"D4\",\"D#4\",\"E"
    "4\",\"F4\",\"F#4\",\"G4\",\"G#4\",\"A4\",\"A#4\",\"B4\",\"C5\",\"C#5\",\"D5\",\"D#5\",\""
    "E5\",\"F5\",\"F#5\",\"G5\",\"G#5\",\"A5\",\"A#5\",\"B5\"],\"default\":36},{\"key\":\"deg"
    "ree\",\"name\":\"Scale Degree\",\"short_name\":\"Deg\",\"options_as_string\":true,\"type"
    "\":\"enum\",\"access\":\"write\",\"options\":[\"I\",\"II\",\"III\",\"IV\",\"V\",\"VI\","
    "\"VII\",\"rest\"],\"default\":0},{\"key\":\"coct\",\"name\":\"Chord Oct\",\"short_name\""
    ":\"Oct\",\"type\":\"int\",\"min\":1,\"max\":5,\"default\":4,\"step\":1},{\"key\":\"famil"
    "y\",\"name\":\"Shape Family\",\"short_name\":\"Fam\",\"options_as_string\":true,\"type\""
    ":\"enum\",\"options\":[\"5th\",\"triad\",\"6th\",\"7th\",\"9th\",\"ext\"],\"default\":1}"
    ",{\"key\":\"shape\",\"name\":\"Chord Shape\",\"short_name\":\"Shape\",\"options_as_strin"
    "g\":true,\"type\":\"enum\",\"options\":[\"rest\",\"note\",\"5\",\"oct\",\"maj\",\"min\","
    "\"dim\",\"aug\",\"sus2\",\"sus4\",\"6\",\"m6\",\"69\",\"maj7\",\"min7\",\"dom7\",\"m7b5"
    "\",\"dim7\",\"mMaj7\",\"7sus4\",\"7sus2\",\"aug7\",\"maj7#5\",\"7b5\",\"add9\",\"madd9\""
    ",\"maj9\",\"min9\",\"9\",\"7b9\",\"7#9\",\"m9b5\",\"11\",\"m11\",\"maj11\",\"13\",\"maj1"
    "3\",\"m13\"],\"default\":4},{\"key\":\"inv\",\"name\":\"Inversion\",\"short_name\":\"Inv"
    "\",\"type\":\"int\",\"min\":-3,\"max\":3,\"default\":0,\"step\":1},{\"key\":\"len\",\"na"
    "me\":\"Length\",\"short_name\":\"Len\",\"type\":\"int\",\"min\":1,\"max\":64,\"default\""
    ":8,\"step\":1},{\"key\":\"off\",\"name\":\"Offset\",\"short_name\":\"Off\",\"type\":\"in"
    "t\",\"min\":0,\"max\":15,\"default\":0,\"step\":1},{\"key\":\"ccolour\",\"name\":\"Colou"
    "r\",\"short_name\":\"Col\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"c"
    "lose\",\"open\",\"drop2\",\"drop3\",\"drop2+4\",\"shell\",\"rootless\",\"quartal\",\"spr"
    "ead\",\"cluster\"],\"default\":0},{\"key\":\"cstrum\",\"name\":\"Strum\",\"short_name\":"
    "\"Strm\",\"type\":\"int\",\"min\":0,\"max\":100,\"default\":0,\"step\":1},{\"key\":\"cve"
    "l\",\"name\":\"Chord Vel\",\"short_name\":\"CVel\",\"type\":\"int\",\"min\":-63,\"max\":"
    "63,\"default\":0,\"step\":1},{\"key\":\"cgate\",\"name\":\"Chord Gate\",\"short_name\":"
    "\"CGat\",\"type\":\"int\",\"min\":-50,\"max\":50,\"default\":0,\"step\":1},{\"key\":\"cm"
    "ute\",\"name\":\"Mute\",\"short_name\":\"Mute\",\"options_as_string\":true,\"type\":\"en"
    "um\",\"options\":[\"off\",\"on\"],\"default\":0},{\"key\":\"rhythm\",\"name\":\"Rhythm\""
    ",\"short_name\":\"Rhy\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"hold"
    "\",\"half\",\"quarter\",\"eighth\",\"16th\",\"offbeat\",\"dotted\",\"push\",\"tresillo\""
    ",\"son 3-2\",\"son 2-3\",\"rumba\",\"bossa\",\"baiao\",\"montuno\",\"charl\",\"charl 2\""
    ",\"shuffle\",\"comp\",\"gallop\",\"drive\",\"anthem\",\"garage\",\"broken\"],\"default\""
    ":0},{\"key\":\"ctrans\",\"name\":\"Transpose\",\"short_name\":\"Trns\",\"type\":\"int\","
    "\"min\":-12,\"max\":12,\"default\":0,\"step\":1},{\"key\":\"genre\",\"name\":\"Genre\","
    "\"short_name\":\"Gen\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"none"
    "\",\"Pop\",\"Rock\",\"Metal\",\"Jazz\",\"Blues\",\"Soul\",\"Gospel\",\"Funk\",\"R&B\",\""
    "Bossa\",\"Latin\",\"House\",\"Reggae\",\"Country\",\"Cinematic\"],\"default\":0},{\"key"
    "\":\"progression\",\"name\":\"Progression\",\"short_name\":\"Prog\",\"options_as_string"
    "\":true,\"type\":\"enum\",\"options\":[\"none\",\"Axis\",\"Sad Axis\",\"Doo-wop\",\"Pach"
    "elbel\",\"Royal Road\",\"Emotional\",\"I-IV-V\",\"Mixolydian\",\"Grunge\",\"Anthem\",\"T"
    "hrash\",\"Power Metal\",\"Doom\",\"Phrygian\",\"ii-V-I\",\"Minor ii-V\",\"Rhythm A\",\"T"
    "urnaround\",\"Coltrane\",\"Tritone\",\"Bird Blues\",\"Modal\",\"12-bar\",\"Quick IV\",\""
    "Minor blues\",\"8-bar\",\"Neo-soul\",\"Montuno\",\"iii-vi-ii-V\",\"Slow jam\",\"Plagal\""
    ",\"Shouting\",\"Walk-up\",\"Amen\",\"JB vamp\",\"Funk turn\",\"P-Funk\",\"Clav\",\"Two-c"
    "hord\",\"Minor lift\",\"Quiet storm\",\"Ipanema\",\"Wave\",\"Desafinado\",\"Corcovado\","
    "\"Guajira\",\"Bolero\",\"Salsa\",\"Deep vamp\",\"Two-bar\",\"Filter\",\"Garage\",\"Skank"
    "\",\"Roots minor\",\"Rockers\",\"Boot scoot\",\"Train\",\"Andalusian\",\"Aeolian\",\"Dor"
    "ian\",\"Picardy\",\"Ostinato\",\"Lament\"],\"default\":0},{\"key\":\"common\",\"name\":"
    "\"Common Prog\",\"short_name\":\"Cmn\",\"options_as_string\":true,\"type\":\"enum\",\"op"
    "tions\":[\"none\",\"I-V-vi-IV\",\"vi-IV-I-V\",\"I-vi-IV-V\",\"I-IV-V\",\"I-IV-I-V\",\"ii"
    "-V-I\",\"I-V-IV\",\"I-iii-IV-V\",\"vi-V-IV-V\",\"i-VI-III-VII\",\"i-iv-v\",\"i-VII-VI-VI"
    "I\"],\"default\":0},{\"key\":\"uncommon\",\"name\":\"Uncommon\",\"short_name\":\"Unc\","
    "\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"none\",\"I-bIII-IV-iv\",\"Ph"
    "rygian\",\"Lydian II\",\"Backdoor\",\"bVI-bVII-I\",\"i-v-bVI-bVII\",\"Chrom desc\",\"Bor"
    "rowed IV\",\"Secondary V\",\"i-bVI-iv-V\",\"Double plagal\",\"Aug lift\",\"Tritone col\""
    "],\"default\":0},{\"key\":\"colour\",\"name\":\"Colour\",\"short_name\":\"Col\",\"option"
    "s_as_string\":true,\"type\":\"enum\",\"options\":[\"close\",\"open\",\"drop2\",\"drop3\""
    ",\"drop2+4\",\"shell\",\"rootless\",\"quartal\",\"spread\",\"cluster\"],\"default\":0},{"
    "\"key\":\"grouping\",\"name\":\"Voice Grouping\",\"short_name\":\"Grp\",\"options_as_str"
    "ing\":true,\"type\":\"enum\",\"options\":[\"none\",\"dynamic\",\"dyn +1oct\",\"dyn +2oct"
    "\",\"C1-B2\",\"C2-B3\",\"C3-B4\",\"open 1\",\"open 2\",\"open 3\",\"guitar\",\"drop 2\","
    "\"drop 3\",\"drop 4\",\"drop 2+3\",\"drop 2+4\"],\"default\":0},{\"key\":\"scale\",\"nam"
    "e\":\"Scale\",\"short_name\":\"Scale\",\"options_as_string\":true,\"type\":\"enum\",\"op"
    "tions\":[\"Chromatic\",\"Major\",\"Minor\",\"Dorian\",\"Phrygian\",\"Lydian\",\"Mixolydi"
    "an\",\"Locrian\",\"HarmMinor\",\"MelMinor\",\"PentMaj\",\"PentMin\",\"Blues\"],\"default"
    "\":2},{\"key\":\"key\",\"name\":\"Key\",\"short_name\":\"Key\",\"options_as_string\":tru"
    "e,\"type\":\"enum\",\"options\":[\"C\",\"C#\",\"D\",\"D#\",\"E\",\"F\",\"F#\",\"G\",\"G#"
    "\",\"A\",\"A#\",\"B\"],\"default\":9},{\"key\":\"steps\",\"name\":\"Chords\",\"short_nam"
    "e\":\"Chrds\",\"type\":\"int\",\"min\":1,\"max\":16,\"default\":4,\"step\":1},{\"key\":"
    "\"rate\",\"name\":\"New Chord Len\",\"short_name\":\"Rte\",\"options_as_string\":true,\""
    "type\":\"enum\",\"options\":[\"2 bar\",\"1 bar\",\"1/2\",\"1/4\"],\"default\":1},{\"key"
    "\":\"run\",\"name\":\"Run\",\"short_name\":\"Run\",\"options_as_string\":true,\"type\":"
    "\"enum\",\"options\":[\"off\",\"on\"],\"default\":1},{\"key\":\"octave\",\"name\":\"Octa"
    "ve\",\"short_name\":\"Oct\",\"type\":\"int\",\"min\":-2,\"max\":2,\"default\":0,\"step\""
    ":1},{\"key\":\"velocity\",\"name\":\"Velocity\",\"short_name\":\"Vel\",\"type\":\"int\","
    "\"min\":1,\"max\":127,\"default\":100,\"step\":1},{\"key\":\"gate\",\"name\":\"Gate\",\""
    "short_name\":\"Gate\",\"type\":\"int\",\"min\":5,\"max\":100,\"default\":90,\"step\":1},"
    "{\"key\":\"hum_vel\",\"name\":\"Human Vel\",\"short_name\":\"HuVel\",\"type\":\"int\",\""
    "min\":0,\"max\":100,\"default\":0,\"step\":1},{\"key\":\"roll_vel\",\"name\":\"Randomize"
    " Vel\",\"short_name\":\"RndVel\",\"options_as_string\":true,\"type\":\"enum\",\"access\""
    ":\"write\",\"options\":[\"off\",\"on\"],\"default\":0},{\"key\":\"hum_time\",\"name\":\""
    "Human Time\",\"short_name\":\"HuTim\",\"type\":\"int\",\"min\":0,\"max\":100,\"default\""
    ":0,\"step\":1},{\"key\":\"roll_time\",\"name\":\"Randomize Time\",\"short_name\":\"RndTi"
    "m\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"options\":[\"off"
    "\",\"on\"],\"default\":0},{\"key\":\"swing\",\"name\":\"Swing\",\"short_name\":\"Swng\","
    "\"type\":\"int\",\"min\":0,\"max\":75,\"default\":0,\"step\":1},{\"key\":\"lanes\",\"nam"
    "e\":\"Note Lanes\",\"short_name\":\"Lanes\",\"options_as_string\":true,\"type\":\"enum\""
    ",\"options\":[\"scale\",\"diatonic\"],\"default\":0},{\"key\":\"preview\",\"name\":\"Pre"
    "view\",\"short_name\":\"Prev\",\"options_as_string\":true,\"type\":\"enum\",\"options\":"
    "[\"off\",\"chord\",\"loop\"],\"default\":0},{\"key\":\"read\",\"name\":\"Read Clip\",\"s"
    "hort_name\":\"Read\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"off\","
    "\"on\"],\"default\":0,\"access\":\"write\"},{\"key\":\"read_mode\",\"name\":\"Read Mode"
    "\",\"short_name\":\"RdMod\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\""
    "replace\",\"append\"],\"default\":0},{\"key\":\"defoct\",\"name\":\"Octave Default\",\"s"
    "hort_name\":\"Oct\",\"type\":\"int\",\"min\":1,\"max\":5,\"default\":3,\"step\":1},{\"ke"
    "y\":\"bars\",\"name\":\"Clip Bars\",\"short_name\":\"Bars\",\"type\":\"int\",\"min\":1,"
    "\"max\":16,\"default\":4,\"step\":1},{\"key\":\"stamp\",\"name\":\"Stamp Clip\",\"short_"
    "name\":\"Stamp\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"off\",\"on"
    "\"],\"default\":0,\"access\":\"write\"},{\"key\":\"stamp_mode\",\"name\":\"Stamp Mode\","
    "\"short_name\":\"StMod\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"rec"
    " arm\",\"write file\"],\"default\":0},{\"key\":\"clear\",\"name\":\"Clear\",\"short_name"
    "\":\"Clear\",\"options_as_string\":true,\"type\":\"enum\",\"options\":[\"off\",\"on\"],"
    "\"default\":0,\"access\":\"write\"},{\"key\":\"play\",\"name\":\"Play Chord\",\"short_na"
    "me\":\"Play\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"option"
    "s\":[\"off\",\"on\"],\"default\":0},{\"key\":\"duplicate\",\"name\":\"Duplicate\",\"shor"
    "t_name\":\"Dup\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"opt"
    "ions\":[\"off\",\"on\"],\"default\":0},{\"key\":\"stretch\",\"name\":\"Double Length\","
    "\"short_name\":\"Dbl\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\""
    ",\"options\":[\"off\",\"on\"],\"default\":0},{\"key\":\"compress\",\"name\":\"Half Lengt"
    "h\",\"short_name\":\"Hlf\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"wri"
    "te\",\"options\":[\"off\",\"on\"],\"default\":0},{\"key\":\"undo\",\"name\":\"Undo\",\"s"
    "hort_name\":\"Und\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\""
    "options\":[\"off\",\"on\"],\"default\":0},{\"key\":\"redo\",\"name\":\"Redo\",\"short_na"
    "me\":\"Red\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"options"
    "\":[\"off\",\"on\"],\"default\":0},{\"key\":\"insert\",\"name\":\"Insert Chord\",\"short"
    "_name\":\"Ins\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"opti"
    "ons\":[\"off\",\"on\"],\"default\":0},{\"key\":\"remove\",\"name\":\"Delete Chord\",\"sh"
    "ort_name\":\"Del\",\"options_as_string\":true,\"type\":\"enum\",\"access\":\"write\",\"o"
    "ptions\":[\"off\",\"on\"],\"default\":0}]";
